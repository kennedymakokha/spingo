...
const page = () => {
  ...
  const fetchData = async () => {
    try {
      ...
      const results = await apiClient().get<Transaction[]>(`wallet/contributions`);
      setTransactions(results.data.sort((a, b) => new Date(b.createdAt).getTime() - new Date(a.createdAt).getTime()));
